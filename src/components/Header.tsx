...
export const Header: React.FunctionComponent<React.PropsWithChildren<HeaderProps>> = ({
  ...
  const headerOptions = useRef([
    { optionName: "GitHub", icon: <FaGithub className={headerOptionIconClassList} /> },
  ...
  return (
    ...
    ">
      ...
      <div className="search-input-wrapper flex flex-row items-center justify-center gap-1">
        ...
        <button className="px-3 py-1.5 rounded-md border border-transparent bg-purple-700 hover:bg-purple-800 
